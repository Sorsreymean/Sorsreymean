  ...
  <section>
     <div class=" my-12 2xl:mx-80 xl:mx-24 md:text-md border lg:hidden">
                <div class="border-b py-xl-20 flex justify-between">
                    <router-link to="/pricing/desktop-2price"><button type="button" class="m-2 border rounded p-4"><i class="pi pi-chevron-left" style="font-size:25px"></i></button>
                    </router-link>
                    <p class="text-4xl font-semibold p-4 text-center">3 Users</p>
                    <button type="button" class="m-2 border p-4 rounded"><i class="pi pi-pause" style="font-size:25px"></i></button>
                </div>
                <div class="text-center leading-10 sm:block">
                    <hr>
                    <p class="font-semibold text-2xl p-4">$78/month</p>
                    <p class="text-lg">Billed as $936/year</p>
                    <p class="text-sm p-4">Annual subscription</p>
                    <button class="border rounded-full text-white bg-cyan-600 w-28 h-8 my-6 text-center pt-0 text-sm hover:bg-cyan-900" type="button">BUY NOW</button>
                </div>
